...
/※35
INSERT INTO 口座(口座番号,名義,種別,残高,更新日) VALUES ('0652281' , 'タカギ　ノブオ' , '1' , 100000 + 3000 , '2018-04-01');
INSERT INTO 口座(口座番号,名義,種別,残高,更新日) VALUES ('1026413' , 'マツモト　サワコ' , '1' , 300000 + 3000 , '2018-04-02');
INSERT INTO 口座(口座番号,名義,種別,残高,更新日) VALUES ('2239710' , 'タカギ　ノブオ' , '1' , 1000000 + 3000 , '2018-04-03');

/※36
UPDATE 口座
SET 残高= (残高 - 3000)* 1.003
FROM 口座
WHERE 口座番号IN ('0652281' , '1026413' , '2239710')
...
AND SUBSTRING(CAST(残高) AS VARCHER)
LENGTH(CAST(残高 AS VARCHAR)-2,3) = '000'
...
/※47
SELECT 口座番号,名義,種別,残高,SUBSTRING(CAST (更新日 AS VARCHAR),1,4) || '年' ||SUBSTRING(CAST (更新日 AS VARCHAR),6,2) || '月' || SUBSTRING(CAST (更新日 AS VARCHAR),9,2) || '日' AS 更新日
FROM 口座
WHERE 更新日 >= '2018-01-01'

/※48
SELECT COALESCE(CAST(更新日 AS VARCHER), '設定なし') AS 更新日 
FROM 口座